...
import { Bar, Heatmap, KIND_COLORS, LoginGate, ProgressRing } from "@/components/ui";
import { Kind, Sheet } from "@/lib/model";
...
export default function Dashboard() {
  const { sheets, stats, authed, loading, refresh } = useTracker();

...
import { Bar, Chip, KIND_COLORS, NEXT_STATUS } from "@/components/ui";
...
export default function SheetView({
  ...
  initial: { sheets: import("@/lib/model").State["sheets"]; progress: import("@/lib/model").State["progress"] };
  sheetId: number;
}) {
  const router = useRouter();
  const { sheets, stats, setStatus, getStatus } = useTracker(initial);
